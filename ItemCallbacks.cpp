...
void ItemCallbacks::on_trade_add_item(GW::HookStatus* status, void* packet) { items_changed = true; }
...
void ItemCallbacks::on_item_update_quantity(GW::HookStatus* status, void* packet) { items_changed = true; }
...
void ItemCallbacks::on_item_moved_to_location(GW::HookStatus* status, void* packet) { items_changed = true; }

void ItemCallbacks::on_inventory_create_bag(GW::HookStatus* status, void* packet) { items_changed = true; }

void ItemCallbacks::on_item_weapon_set(GW::HookStatus* status, void* packet) { items_changed = true; }
...
void ItemCallbacks::on_item_change_location(GW::HookStatus* status, void* packet) { items_changed = true; }
...
void ItemCallbacks::on_drop_item(GW::HookStatus* status, void* packet) { items_changed = true; }

void ItemCallbacks::on_drop_gold(GW::HookStatus* status, void* packet) { items_changed = true; }
